...
# Use GITHUB_REF, but if the ref is main, keep it as main
...
for my $filename (@files) {
    ...
    for my $line (<$src>) {
        ...
        $output->print("source: [$include_filename](https://github.com/lestrrat-go/sfv/blob/$link_ref/$include_filename)\n");
